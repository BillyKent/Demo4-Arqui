...
import com.software.miedo.demo4.data.QueryUtils;
...
public class CommentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog.setTitle("Enviando Comentario");
    ...
    private void enviarComentario() {
        ...
        String contenido = et_username.getText().toString().trim() +
        ...
        new AsyncTask<String, Void, Integer>() {
            ...
            protected Integer doInBackground(String... strings) {
                ...
                Integer codigo = QueryUtils.doPost(CommentActivity.this.id, strings[0]);
            ...
            protected void onPostExecute(Integer code) {
                if (code == 201) {
                    ...
                    if (progressDialog.isShowing()) {
                        progressDialog.hide();
                        Toast.makeText(CommentActivity.this,"Error al enviar comentario",Toast.LENGTH_SHORT).show();
                    }
                }
...
/*
        Call<String> call = api.postComment(comentario);
