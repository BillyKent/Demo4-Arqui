...
public class HomeViewModel extends ViewModel implements HomeContract.Presenter {
    ...
    private static final String BASE_IMAGE_URL = "http://169.62.31.213:8082/alfresco/" +
    ...
    private void fetchRestauranteData(RestaurantesRequestAPI api, String id) {
        ...
        restauranteCall.enqueue(new Callback<String>() {
            ...
            public void onResponse(Call<String> call, Response<String> response) {
                ...
                if(mData.isEmpty()){
                    mView.mostrarError("No se encontraron datos.");
                }
            }
            ...
            public void onFailure(Call<String> call, Throwable t) {
                ...
                mView.mostrarError("Error en la petición al servidor.");
        ...
        call.enqueue(new Callback<String>() {
            ...
            public void onResponse(Call<String> call, Response<String> response) {
                ...
                if (response.code() == 200) {
                    ...
                    mView.mostrarError("Error "+response.code());
                }
